    ...
    */
    ...
    'attributes' => [
       ...
       'ar' => [
        ...
        'parts.*.id' => [
            'exists' => 'قطعة الغيار المحددة غير موجودة.',
        ],

        'parts.*.quantity' => [
            'required_with' => 'يرجى إدخال كمية قطعة الغيار.',
            'numeric'     => 'الكمية يجب أن تكون رقمًا.',
            'min'         => 'الكمية يجب ألا تقل عن 1.',
        ],

        'parts.*.price' => [
            'required_with' => 'يرجى إدخال سعر قطعة الغيار.',
            'numeric'     => 'السعر يجب أن يكون رقمًا.',
            'min'         => 'السعر يجب ألا يقل عن 0.',
        ],
    ],
];
